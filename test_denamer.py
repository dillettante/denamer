...
MUST_DETECT = [
    ...
    # 아래는 외부 검토(2026-08)에서 드러난 미탐들. 이 목록이 웹판 패리티 검사의
    # 코퍼스이기도 하므로, 여기 없는 동작은 두 구현이 조용히 갈라진다 —
    # 실제로 이름 규칙 수정이 파이썬에만 들어간 채 웹판이 옛 동작으로 남아 있었다.
    ("사건번호+조사", "사건번호는 2020가합12345이며, 진행되었다", "2020가합12345"),
    ("사건번호+조사(행정)", "서울행정법원 2021구합5678을 확인", "2021구합5678"),
    ("계좌 7자리 세그먼트", "입금계좌 하나은행 3333-02-1234567", "3333-02-1234567"),
    ("이름 뒤 법인꼬리", "원고 김철수는 주식회사 동방화학을 상대로 청구한다", "김철수"),
    ("전각 주민번호", "주민등록번호 ８８０１０１-１２３４５６７", "８８０１０１-１２３４５６７"),
    ("전각 전화", "연락처 ０１０-１２３４-５６７８", "０１０-１２３４-５６７８"),
]
